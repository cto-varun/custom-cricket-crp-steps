...
const ErrorModal = _ref => {
  ...
  const [showDetails, setShowDetails] = (0, _react.useState)(true);
  let details = null;
  if (technicalDetails) {
    details = technicalDetails.map((_ref2, index) => {
      let {
        code,
        message
      } = _ref2;
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        key: index
      }, /*#__PURE__*/_react.default.createElement("span", null, code, ": ", message));
    });
  }
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "customer-360-payment-error",
    style: {
      height: '100%'
    }
  }, /*#__PURE__*/_react.default.createElement("div", {
    className: "svg-container side-spacing"
  }, /*#__PURE__*/_react.default.createElement("div", {
